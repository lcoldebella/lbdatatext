...
public class PaddingTypeConverter {
	public static PaddingType stringToType(String value) {			
		if (value.startsWith("PADLEFT"))
			return PaddingType.PAD_LEFT;
		else if (value.startsWith("PADRIGHT"))
			return PaddingType.PAD_RIGHT;
		else
			throw new RuntimeException("PaddingType unknown");
	}
}
